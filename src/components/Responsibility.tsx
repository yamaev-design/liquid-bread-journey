...
const Responsibility = () => {
  return (
    <section id="responsibility" className="py-20 px-6 bg-gradient-to-b from-background to-card">
        ...
        <div className="mb-16 animate-fade-in">
          <div className="relative bg-gradient-amber p-12 md:p-16 rounded-3xl shadow-glow">
            ...
            <blockquote className="relative z-10">
              <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground text-balance leading-relaxed mb-6">
              ...
              <footer className="text-lg md:text-xl text-primary-foreground/80 font-medium">
                — Мудрость веков
              </footer>
            </blockquote>
          </div>
